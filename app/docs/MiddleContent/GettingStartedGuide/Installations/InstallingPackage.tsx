...
import { Box, Flex, Spacer, Text, Tabs, TabList, Tab, TabPanels, TabPanel, Tooltip, IconButton } from '@chakra-ui/react';
          ...
          <TabPanels bg={'whiteAlpha.200'} borderRadius="5px" my={4}>
            <TabPanel>
                <Flex flexDir='row' align={'center'} >
                    <Box><span className={styles.green}>npm install</span> @react-navigation/native</Box>
                    <Spacer />
                        <Box>
            ...
            <TabPanel>
                <Flex flexDir='row' align={'center'} >
                    <Box><span className={styles.green}>yarn add</span> @react-navigation/native</Box>
                    <Spacer />
                    <Box>
                        <Tooltip label={isCopied ? 'Copied!' : 'Copy code'} placement="top" hasArrow>
                            <IconButton
